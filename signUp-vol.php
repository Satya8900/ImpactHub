...
<body id="bootstrap-override">
    ...
    <div class="sign-up">
        <form id="createAccount" action="Volunteer/SignUp_Vol.php" method="POST">
            <h1 class="form__title">SignUp</h1>
            <div class="form__message form__message--error"></div>
            <div class="form__input-group">
                <input type="text" id="name" class="form__input" name="name" required autofocus placeholder="Name">
            ...
            <button class="form__button" name="create" type="submit">Create</button>
            <p class="form__text">
